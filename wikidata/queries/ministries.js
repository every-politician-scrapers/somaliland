...
module.exports = function () {
    return `SELECT DISTINCT ?item ?itemLabel ?minister ?ministerLabel (MIN(YEAR(?start)) AS ?began) (MAX(YEAR(?end)) AS ?ended) WHERE {
    ...
    GROUP BY ?item ?itemLabel ?minister ?ministerLabel
